    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            for (let i = result.length - 1; i >= 0; i--) {
                ...
                $(".nomeCreatore")
                    .attr("class", obj["nomeCreatore"])
                    .text(obj["nomeCreatore"] + " " + obj["cognomeCreatore"]);
                $(".tipologia")
                    .attr("class", obj["tipologia"])
                    .text("Tipologia: " + obj["tipologia"]);
                let inizioEvento = obj["dataI"].replace("T", "   ");
                $(".dataI")
                    .attr("class", obj["dataI"])
                    .text("Inizio evento: " + inizioEvento);
            }
        },
    });
}
